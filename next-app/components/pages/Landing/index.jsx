    ...
    <div className="w-full">
      ...
      <section className="flex justify-center gap-10 py-12">
        <div className="text-center">
          <Image
            ...
            width={360}
            height={240}
            className="w-90 h-60 object-contain mx-auto"
          />
      ...
      <section className="flex justify-center items-center gap-12 py-16">
        ...
        <p className="max-w-md text-xl">
          ...
          user-friendly way to explore a data set of asylum decisions between FY
          2016 and May 2021 by the USCIS Asylum Office, which we received
          through a Freedom of Information Act request. You can search for
          information on asylum grant rates by year, nationality, and asylum
          office, visualize the data with charts and heat maps, and download the
          data set.
        </p>
      </section>
